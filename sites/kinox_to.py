...
URL_CINEMA_PAGE = 'https://%s/Kinox-filme.html'
URL_GENRE_PAGE = 'https://%s/Genre.html'
URL_MOVIE_PAGE = 'https://%s/All-Filme.html'
URL_SERIE_PAGE = 'https://%s/Fernseh-TVSerien.html'
URL_DOCU_PAGE = 'https://%s/Documentations.html'
URL_FAVOURITE_MOVIE_PAGE = 'https://%s/Popular-Filme.html'
URL_FAVOURITE_SERIE_PAGE = 'https://%s/Popular-TVSerien.html'
URL_FAVOURITE_DOCU_PAGE = 'https://%s/Popular-Dokumentationen.html'
